...
const SearchInput = ({
  setSearchTerm
}: Pick<CatalogFiltersState, 'setSearchTerm'>): JSX.Element => {
...
const DisplayTypePicker = ({
  activeDisplayType,
  enabledDisplayTypes,
  setDisplayType
}: Pick<CatalogFiltersState, 'enabledDisplayTypes' | 'setDisplayType'> & {
  activeDisplayType: CatalogFiltersState['displayType'] | CatalogFiltersState['resultsDisplayType'];
}): JSX.Element => {
