...
```
# CartUIProvider takes a checkout base url to handle the checkout redirection. It provides access to UI behavior (like: to toggle cart modal) and access to manage a local cart object.
