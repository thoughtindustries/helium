...
const setupProps = (
    ...
    displayCutoff,
    categories: getCategories(numberOfCategories, numberOfSubcategories, openLinkInNewTab)
});
...
<div>
  ...
  >
    ...
    >
      ...
      <ul
        class="grid grid-cols-2 md:grid-cols-3 link-matrix-category__container"
      >
        <li
          class="border-r border-solid border-gray-300 mb-4"
        >
          <div
            class="pl-8 pr-8 link-matrix-category"
          >
            <h4
            ...
            >
              <li
                class="pl-5 link-matrix-category__subcategory"
              >
                <a
