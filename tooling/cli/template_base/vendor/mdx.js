...
var require_util = __commonJS({
  "node_modules/@mdx-js/rollup/node_modules/source-map/lib/util.js"(exports) {
    ...
    function join(aRoot, aPath) {
      ...
      const joined = aPath.charAt(0) === "/" ? aPath : normalize6(aRoot.replace(/\/+$/, "") + "/" + aPath);
      if (aRootUrl) {
...
var require_binary_search = __commonJS({
  "node_modules/@mdx-js/rollup/node_modules/source-map/lib/binary-search.js"(exports) {
    ...
    exports.search = function search2(aNeedle, aHaystack, aCompare, aBias) {
      ...
      let index2 = recursiveSearch(-1, aHaystack.length, aNeedle, aHaystack, aCompare, aBias || exports.GREATEST_LOWER_BOUND);
      if (index2 < 0) {
        return -1;
      }
      while (index2 - 1 >= 0) {
...
var require_wasm = __commonJS({
  "node_modules/@mdx-js/rollup/node_modules/source-map/lib/wasm.js"(exports, module2) {
    ...
    module2.exports = function wasm() {
      ...
      const callbackStack = [];
      cachedWasm = readWasm().then((buffer3) => {
  ...
  "node_modules/@mdx-js/rollup/node_modules/source-map/lib/source-map-consumer.js"(exports) {
    ...
    var IndexedSourceMapConsumer = class extends SourceMapConsumer {
      ...
      allGeneratedPositionsFor(aArgs) {
        ...
        const mappings = [];
        let index2 = this._findMapping(needle, this._originalMappings, "originalLine", "originalColumn", util.compareByOriginalPositions, binarySearch.LEAST_UPPER_BOUND);
        if (index2 >= 0) {
  ...
  "node_modules/acorn/dist/acorn.js"(exports, module2) {
    (function(global, factory2) {
      ...
      var Parser3 = function Parser4(options, input, startPos) {
        ...
        this.reservedWordsStrictBind = wordsRegexp2(reservedStrict + " " + reservedWords3.strictBind);
      ...
      pp$12.parseForStatement = function(node) {
        ...
        if (this.type === types2._in || (isForOf = this.options.ecmaVersion >= 6 && this.isContextual("of"))) {
          if (this.options.ecmaVersion >= 9) {
            if (this.type === types2._in) {
              if (awaitAt > -1) {
                this.unexpected(awaitAt);
      ...
      types2._function.updateContext = types2._class.updateContext = function(prevType) {
        if (prevType.beforeExpr && prevType !== types2._else && !(prevType === types2.semi && this.curContext() !== types$12.p_stat) && !(prevType === types2._return && lineBreak2.test(this.input.slice(this.lastTokEnd, this.start))) && !((prevType === types2.colon || prevType === types2.braceL) && this.curContext() === types$12.b_stat)) {
      ...
      pp$42.parseSubscript = function(base2, startPos, startLoc, noCalls, maybeAsyncArrow, optionalChained, forInit) {
      ...
      pp$42.parsePropertyValue = function(prop, isPattern, isGenerator, isAsync, startPos, startLoc, refDestructuringErrors, containsEsc) {
      ...
      pp$42.parseExprList = function(close, allowTrailingComma, allowEmpty, refDestructuringErrors) {
        var elts = [], first = true;
        while (!this.eat(close)) {
          if (!first) {
            this.expect(types2.comma);
      ...
      var RegExpValidationState3 = function RegExpValidationState4(parser) {
        ...
        this.unicodeProperties = data3[parser.options.ecmaVersion >= 12 ? 12 : parser.options.ecmaVersion];
        this.source = "";
        this.flags = "";
        this.start = 0;
        this.switchU = false;
...
var DefinedInfo = class extends Info {
  constructor(property, attribute, mask, space) {
    ...
    while (++index2 < checks.length) {
      mark(this, checks[index2], (mask & types_exports[checks[index2]]) === types_exports[checks[index2]]);
    }
  }
};
...
function createProcessor(options = {}) {
  ...
  pipeline.use(remarkMarkAndUnravel).use(remarkPlugins || []).use(remark_rehype_default, { allowDangerousHtml: true, passThrough: nodeTypes }).use(rehypePlugins || []);
  if (format === "md") {
    pipeline.use(rehypeRemoveRaw);
  }
  pipeline.use(rehypeRecma).use(recmaDocument, { ...rest, outputFormat }).use(recmaJsxRewrite, { providerImportSource, outputFormat });
  if (!jsx) {
...
function createFormatAwareProcessors(compileOptions = {}) {
  ...
  let cachedMdx;
  return {
    extnames: compileOptions.format === "md" ? mdExtensions : compileOptions.format === "mdx" ? mdxExtensions : mdExtensions.concat(mdxExtensions),
    process: process3,
    processSync
  };
